...
const exp = [
  ...
  },
  {
    ...
    place: "International Organization Of Software Development",
    time: "(August, 21 - present)",
    desp: "<li>Took online workshops to help several techies find their Talent and guide their path toward excellence.</li><li>Involved in Development team to ensure quality in all phases of Web Development.</li>",
  },
  {
    title: "Core Committee Member",
    cardImage: "assets/images/experience-page/acm.png",
    place: "Association For Computing Machinery, Manipal",
    time: "(August, 21 - present)",
    desp: "<li>Was responsible in finding brighter minds for clubs to learn new inventions.</li><li>Organized/Helped several successful events: One of which is <b>Joy of giving</b> which involved teaching and helping poor children.</li><li>Actively participated in the club's meetings, discussions, and decision-making processes, contributing ideas and insights to help improve the overall experience of members and achieve club goals.</li>",
  },
];
...
const volunteershipcards = [
  {
    ...
    cardImage: "assets/images/experience-page/hactoberfest.jpg",
    description:
      "I collaborated with other developers to create and contribute to open source projects, gaining valuable experience in teamwork and version control.",
  },
];
...
const mentor = [
  {
    title: "C/C++",
    subtitle: "",
    image: "assets/images/experience-page/c++.webp",
    desp: "//about c/c++ ",
